...
class KuisVerb extends StatelessWidget {
  ...
  //     appBar: AppBar(title: const Text('Quiz Verb'), backgroundColor: Colors.blueAccent, centerTitle: true),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFEBF5FB),
      appBar: AppBar(title: Text('Quiz Verb'), backgroundColor: Colors.blueAccent, centerTitle: true),
      body: SingleChildScrollView(
